...
export const List = () => {
    ...
    return (
        <>
            ...
            <section className="py-16 px-44 flex flex-col gap-6 border-b border-main-200">
                ...
                <div className="flex flex-row items-center gap-2 bg-white border border-main-200 rounded-full px-4 py-2 shadow-sm w-fit hover:shadow-md transition duration-300">
                    <input
                        className="bg-transparent text-main-700 text-sm placeholder:text-main-400 focus:outline-none w-72"
                        placeholder="Titre..."
                        value={search}
